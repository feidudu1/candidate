  ...
  return (
    <div className="content">
        ...
        {users.map((user) => (
          ...
          >
            ...
            <List.Item
              prefix={
                <div
                  className={`prefixText ${user.type === 1 ? "red" : "blue"}`}
                >
                  <div>
                    <div>竞选编号</div>
                  </div>
                  <div className="prefixNo">{user.id}</div>
                </div>
              }
      ...
      注意：
        ...
        因为网页的传播性质，未避免涉及个人信息泄露等纠纷的发生，同时也因为本人认知所限，目前只记录了部分候选人的信息。
        转发仅限业主群和业主之间，否则造成的后果自负。
